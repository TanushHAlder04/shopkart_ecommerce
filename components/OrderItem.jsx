                                ...
                                <div className="flex flex-col justify-center text-sm">
                                    ...
                                    <div>
                                        {ratings.find(rating => order.id === rating.orderId && item.product.id === rating.productId)
                                            ...
                                            : <button onClick={() => setRatingModal({ orderId: order.id, productId: item.product.id })} className={`text-blue-600 hover:bg-blue-50 font-medium px-2 py-0.5 rounded transition ${order.status !== "DELIVERED" && 'hidden'}`}>Rate Product</button>
                                        }</div>
