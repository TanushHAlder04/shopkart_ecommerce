...
const OurSpecs = () => {
    ...
    return (
        <div id="about" className='px-6 my-20 max-w-6xl mx-auto scroll-mt-10'>
            <div className="w-full h-px bg-gradient-to-r from-transparent via-slate-400/80 to-transparent mb-20" />
